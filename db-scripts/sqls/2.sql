...
--
-- Host: localhost:3306
-- Generation Time: Apr 13, 2017 at 12:44 PM
...
(1, 'Abhijit', 'Abhijit', 10, 20, 1, 1),
(2, 'Vandana', 'Vandana', 20, 30, 1, 1);
...
--
ALTER TABLE `batch`
  MODIFY `batchId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Batch Id', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `batchCanOverlap`
--
ALTER TABLE `batchCanOverlap`
  MODIFY `boId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'BatchOverlap Id';
--
-- AUTO_INCREMENT for table `batchClass`
--
ALTER TABLE `batchClass`
  MODIFY `bcId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Batch Class Id';
--
-- AUTO_INCREMENT for table `batchRoom`
--
ALTER TABLE `batchRoom`
  MODIFY `brId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Batch Room Mapping Id';
--
...
--
ALTER TABLE `classRoom`
  MODIFY `crId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Class Room Mapping Id';
--
...
--
ALTER TABLE `subject`
  MODIFY `subjectId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Subject Id', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `subjectBatchTeacher`
--
ALTER TABLE `subjectBatchTeacher`
  MODIFY `sbtId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SBT Id', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `subjectClassTeacher`
--
ALTER TABLE `subjectClassTeacher`
  MODIFY `sctId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Subject Class Teacher Mapping Id', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `subjectRoom`
--
ALTER TABLE `subjectRoom`
  MODIFY `srId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Subject Room Preference Id';
--
-- AUTO_INCREMENT for table `teacher`
--
ALTER TABLE `teacher`
  MODIFY `teacherId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Teacher Id', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `timeTable`
--
ALTER TABLE `timeTable`
  MODIFY `ttId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'TimeTable Id';
--
