...
--
-- Host: localhost:3306
-- Generation Time: Apr 13, 2017 at 10:58 AM
...
--
ALTER TABLE `subjectBatchTeacher`
  MODIFY `sbtId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'SBT Id';
--
-- AUTO_INCREMENT for table `subjectClassTeacher`
--
ALTER TABLE `subjectClassTeacher`
  MODIFY `sctId` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Subject Class Teacher Mapping Id';
--
