...
INSERT INTO subjectRoom(subjectId, roomId, snapshotId) VALUES ((SELECT subjectId FROM subject WHERE subjectShortName="OS"),(SELECT roomId from room WHERE roomShortName="AC-203"), 1);
