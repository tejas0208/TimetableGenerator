...
INSERT INTO subjectRoom(subjectId, roomId, snapshotId) VALUES ((SELECT subjectId FROM subject WHERE subjectShortName="DC"),(SELECT roomId from room WHERE roomShortName="AC-203"), 1);
