...
function teacherInsert() {
	...
	error_log("teacherInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result2 === false) {
		return failMessage();
	} else {
		$resString = "{\"Success\": \"True\",";
...
function subjectInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("insertSubject(): $query2: Result: ".json_encode($result2), 0);
	if($result2 === false) {
		return failMessage();
	} else {
		$resString = "{\"Success\": \"True\",";
...
function classInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("classInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("classInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function batchClassUpdate() {
	...
	if($query2 != "") {
		$result2 = sqlGetAllRows($query2);
		error_log("batchClassUpdate: $query2: Result: ".json_encode($result2), 0);
...
function batchInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("batchInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result2 === false) {
		error_log("batchInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function roomInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("roomInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("roomInsert(): resString: ".failMessage());
		return failMessage();
	}else {
...
function sbtInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("sbtInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("sbtInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function sbtDelete() {
	...
	error_log("sbtDelete: $query3 Result: $result", 0);
	if($result === false) {
		error_log("sbtDelete(): resString: ".failMessage());
		return failMessage();
	}
...
function sctInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("sctInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("sctInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function sctDelete() {
	...
	$result = sqlUpdate($query3);
	error_log("sctDelete(): $query3 Result: $result", 0);
	if($result === false) {
		error_log("sctDelete(): resString: ".failMessage());
		return failMessage();
	}
...
function subjectRoomInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("subjectRoomInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("subjectRoomInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function classRoomInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("classRoomInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("classRoomInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function batchRoomInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("batchRoomInsert: $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("batchRoomInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function configInsert() {
	...
	$result2 = sqlGetAllRows($query2);
	error_log("configInsert(): $query2: Result: ".json_encode($result2), 0);
	if($result === false) {
		error_log("configInsert(): resString: ".failMessage());
		return failMessage();
	} else {
...
function overlappingSBTInsert() {
	...
	error_log("overlappingSBTInsert(): $querySelect2: Result: ".json_encode($result2), 0);
	if($result2 === false) {
		error_log("overlappingSBTInsert(): resString: ".failMessage());
		return failMessage();
	} else {
